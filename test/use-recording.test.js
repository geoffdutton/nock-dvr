...
describe('dvr.record', function () {
  ...
  describe('callback promises', function () {
    it('resolves', function () {
      return dvr
        .record('record handles resovled promises', function () {
    ...
    it('rejects', function () {
      return dvr
        .record('record handles rejected promises', function () {
  ...
  describe('requests - playback', function () {
    ...
    it('plays back cached requests', function () {
      dvr
        .record('plays back request', function () {
  ...
  describe('requests - recording', function () {
    ...
    it("doesn't save a file when no requests are made", function () {
      return dvr
        .record('no file with no request', function () {
          return assert(true)
        })
        .then(function () {
    ...
    describe('makes sure nock is active', function () {
      ...
      it('re-activates nock', function () {
        ...
        return dvr
          .record('re-activates nock', function () {
            return assert(true)
          })
          .then(function () {
